...
{
    public partial class ExpressAdmin : System.Web.UI.Page
    {
        ...
        protected void dtlProducto_ItemCommand(object source, DataListCommandEventArgs e)
        {
            ...
            if (e.CommandName.ToString() == "3")
            {
               ...
               Enc_Factura en = new Enc_Factura();
                ...
                int var = int.Parse(en.ObtenerTotalPorID(pk).ToString());
                int var2 = int.Parse(zona.MontoXpressFactura(pk).ToString());

                txtTotalFactura2.Text = (var+var2).ToString();
                txtExpresstotal.Text = zona.MontoXpressFactura(pk).ToString();
                txtfactutotal.Text = var.ToString();
        ...
        protected void Button39_Click(object sender, EventArgs e)
        {
            try
            {         
            Response.Redirect("ExpressAdmin.aspx");
            }
            catch { }
        }
    }
