<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador.Master" AutoEventWireup="true" CodeBehind="ExpressAdmin.aspx.cs" Inherits="CapaPresentacion.ExpressAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-lg-10 col-sm-10 col-md-10">
                                                    ...
                                                    <table style="width: 100%;">
                                                        ...
                                                        <tr>
                                                         ...
                                                         <tr>
                                                            <td>
                                                                <div class="row">
                                                                    <asp:Label ID="Label15" runat="server" Text="Total Express:"></asp:Label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtExpresstotal" runat="server" Enabled="False" Width="212px">0</asp:TextBox>
                                                            </td>
                                                        </tr>
                                                         ...
                                                         <tr>
                                                            <td>
                                                                <div class="row">
                                                                    <asp:Label ID="Label16" runat="server" Text="Total Factura:"></asp:Label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtfactutotal" runat="server" Enabled="False" Width="212px">0</asp:TextBox>
                                                            </td>
                                                        </tr>
            ...
            <asp:DataList ID="dtlProducto" runat="server" DataSourceID="SqlDataSource1" RepeatColumns="5" RepeatDirection="Horizontal" CellPadding="0" DataKeyField="PK_ID_ENC_FACTURA" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="None" BorderWidth="3px" ForeColor="Black" GridLines="Both" OnItemCommand="dtlProducto_ItemCommand">
                ...
                <ItemTemplate>
                    <table class="w-100" border="1">
                        <tr>
                            ...
                            <td colspan="1">
                                <asp:Label ID="lblPlato" runat="server" Text='<%# Eval("Cliente") %>' Style="width: 200px;"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="1">
                            ...
                            <td colspan="1">
                                <asp:Label ID="Label1" runat="server" BorderStyle="None" BorderWidth="2px" Text='<%# Eval("Agente") %>' Style="width: 200px;"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="1">
                                <asp:Label ID="Label6" runat="server" Text="Lugar de Entrega=" Style="width: 50%;"></asp:Label>
                            </td>
                            <td colspan="1">
                                <asp:Label ID="Label7" runat="server" BorderStyle="None" BorderWidth="2px" Text='<%# Eval("Zona") %>' Style="width: 200px;"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="1">
                                <asp:Label ID="Label13" runat="server" Text="Especificaciones=" Style="width: 50%;"></asp:Label>
                            </td>
                            <td colspan="1">
                                <asp:Label ID="Label14" runat="server" TextMode="MultiLine" BorderStyle="None" BorderWidth="2px" Text='<%# Eval("Especificaciones") %>' Style="width: 200px;"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="1">
                            ...
                            <td colspan="1">
                                <asp:Label ID="Label2" runat="server" BorderStyle="None" BorderWidth="2px" Text='<%# Eval("Total") %>' Style="width: 200px;"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="1">
                                <asp:Label ID="Label8" runat="server" Text="Monto Express=" Style="width: 50%;"></asp:Label>
                            </td>
                            <td colspan="1">
                                <asp:Label ID="Label9" runat="server" BorderStyle="None" BorderWidth="2px" Text='<%# Eval("Precio_Express") %>' Style="width: 200px;"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="1">
                                <asp:Label ID="Label10" runat="server" Text="Monto Total=" Style="width: 50%;"></asp:Label>
                            </td>
                            <td colspan="1">
                                <asp:Label ID="Label12" runat="server" BorderStyle="None" BorderWidth="2px" Text='<%# Eval("FactEx") %>' Style="width: 200px;" Font-Bold="True"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                ...
                <FooterTemplate>
                    <asp:Label ID="lblEmpty" Text="No hay Express en la cola" runat="server" BorderStyle="None" BorderColor="White" Visible='<%#bool.Parse((dtlProducto.Items.Count==0).ToString())%>' BackColor="White">
                    </asp:Label>
                </FooterTemplate>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="PA_CON_FACTURA_ESTADO" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:QueryStringParameter Name="FK_ID_EstadoEncFactura" QueryStringField="FK_ID_EstadoEncFactura" DefaultValue="5" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
