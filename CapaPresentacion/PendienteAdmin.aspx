<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador.Master" AutoEventWireup="true" CodeBehind="PendienteAdmin.aspx.cs" Inherits="CapaPresentacion.PendienteAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-lg-10 col-sm-10 col-md-10">
            ...
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="ModalFacturado1">Entregado</h5>
                    </div>
                    <div class="modal-body">
                        <div class="row justify-content-md-center">
                            <div class="thank-you-pop">
                    ...
                    <div class="modal-footer">
                        <asp:Button ID="Button39" runat="server" Text="Aceptar" type="button" class="btn btn-primary"  OnClick="Button39_Click" />
                                        ...
                                        <div class="modal fade" id="ModalEntregado" tabindex="-1" role="dialog" aria-labelledby="ModalEntregado" aria-hidden="true">
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="ModalEntregado1">Orden Entregada</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-footer">
                        <asp:Button ID="Button3" runat="server" Text="Aceptar" type="button" class="btn btn-primary"  OnClick="Button39_Click" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <asp:DataList ID="dtlProducto" runat="server" DataSourceID="SqlDataSource1" RepeatColumns="5" RepeatDirection="Horizontal" CellPadding="0" DataKeyField="PK_ID_ENC_FACTURA" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="None" BorderWidth="3px" ForeColor="Black" GridLines="Both" OnItemCommand="dtlProducto_ItemCommand">
                ...
                <ItemTemplate>
                    <table class="w-100" border="1">
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Button ID="Button2" runat="server" class="btn btn-success" Text="Entregado" CommandName="3" Style="width: 100%;" CommandArgument='<%# Eval("PK_ID_ENC_FACTURA") %>' />
                            </td>
                        </tr>
                    </table>
                    <br />
                                ...
                                <FooterTemplate>
                    <asp:Label ID="lblEmpty" Text="No hay Pendientes en la cola" runat="server" BorderStyle="None" BorderColor="White" Visible='<%#bool.Parse((dtlProducto.Items.Count==0).ToString())%>' BackColor="White">
                    </asp:Label>
                </FooterTemplate>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="PA_CON_FACTURA_ESTADO_PENDIENTE" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:QueryStringParameter Name="FK_ID_EstadoEncFactura" QueryStringField="FK_ID_EstadoEncFactura" DefaultValue="7" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
